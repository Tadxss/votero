...
export const inputClasses =
  "rounded-2xl border-2 border-neutral-300 bg-[var(--input-bg)] px-4 py-2.5 text-base font-normal text-[var(--foreground)] outline-none transition-colors focus:border-brand-500 dark:border-neutral-700";
